...
public class GameConstants {
    ...
    public static final int GAME_INSTANCE_LENGTH = 16; // GAME_WORLD_WIDTH / 128
    ...
    public static final double GAME_MINIMAP_SCALE = 0.25;
    public static final int GAME_MINIMAP_SCALED_X = 4 * 256; // (1 / SCALE) * (W_WIDTH * SCALE) / 2
